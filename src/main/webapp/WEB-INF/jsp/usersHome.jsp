...
<p align="right">
 ...
 <%-- <p> <security:authorize access="isAuthenticated()">
  					Welcome  <security:authentication property="principal.username" /></security:authorize></p>
  				 --%>
	</section>
	
     Hello ${user.fname} <a href=" <spring:url value="/items/add/?id=${user.id}" />" >POST</a>  
 	<a href=" <spring:url value="/myitemlist/?id=${user.id}" />" >MYLIST</a> 
 	<div class="row" >
